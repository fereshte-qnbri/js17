...
function createCard(cardData) {
  ...
  const cardAccount = document.createElement("p");
  cardAccount.textContent = cardData.account;
  card.appendChild(cardAccount);

  card.addEventListener("click", () => {
    const selectedElement = document.querySelector(".cardSelected");
    selectedElement.textContent = cardData.title;
  });
